 ...
 * SelectTrigger
 *
 * WCAG 2.1 AA: aria-label and other ARIA attributes are properly propagated
 * via the spread operator {...props} to the underlying Radix Trigger.
 * When using SelectTrigger, pass aria-label for accessibility:
 *
 * @example
